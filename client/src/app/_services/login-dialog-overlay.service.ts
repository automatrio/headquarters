...
import { defaultLoginDialogConfig, LoginDialogConfig } from '../_components/login-dialog/login-dialog-config';
import { LoginDialogOverlayRef } from '../_components/login-dialog/login-dialog-overlay-ref';
